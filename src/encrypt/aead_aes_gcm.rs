...
mod tests {
    ...
    fn custom() {
        let aes256gcm = AeadAes256Gcm::creat(b"laocao");
        let salt: &[u8; 32] = &[211, 243, 92, 14, 14, 171, 116, 2, 18, 144, 85, 251, 115, 120, 138, 107, 76, 128, 70, 116, 16, 212, 237, 9, 33, 254, 32, 220, 114, 13, 229, 23];
        let subkey = aes256gcm.generate_sub_key(salt).unwrap();
        let en_vec: [u8; 18] = [144, 30, 66, 215, 196, 137, 126, 65, 206, 55, 181, 245, 166, 97, 110, 33, 99, 187];
